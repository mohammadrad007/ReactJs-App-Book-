...
class App extends Component {
  ...
  addBook(){
    axios.post("http://localhost:3000/books", this.newBookData).then((response)=> {
  ...
  render() {
    ...
    return (
      <div className="App container">
       ...
       <Button className="btn my-3" color="primary" onClick={this.toggleNewBookModal.bind(this)}>Add New Book</Button>
